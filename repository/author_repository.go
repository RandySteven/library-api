...
func (repo *authorRepository) FindAuthorByName(name string) (*models.Author, error) {
...
func (repo *authorRepository) Find() ([]models.Author, error) {
...
func (repo *authorRepository) Save(author *models.Author) (*models.Author, error) {
