...
func (_m *UserUseCase) CreateUser(ctx context.Context, user *models.User) (*models.User, error) {
...
// GetAllUsers provides a mock function with given fields: ctx, whereClause
func (_m *UserUseCase) GetAllUsers(ctx context.Context, whereClause []query.WhereClause) ([]models.User, error) {
