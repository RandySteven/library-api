...
// CreateBorrowRecord provides a mock function with given fields: borrow
func (_m *BorrowUseCase) CreateBorrowRecord(borrow *models.Borrow) (*models.Borrow, error) {
...
// GetAllBorrowsRecord provides a mock function with given fields: whereClauses
func (_m *BorrowUseCase) GetAllBorrowsRecord(whereClauses []query.WhereClause) ([]models.Borrow, error) {
...
// ReturnBorrowedBookByBorrowId provides a mock function with given fields: id
func (_m *BorrowUseCase) ReturnBorrowedBookByBorrowId(id uint) (*models.Borrow, error) {
	ret := _m.Called(id)
